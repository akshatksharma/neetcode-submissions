class Solution {
    func canFinish(_ numCourses: Int, _ prerequisites: [[Int]]) -> Bool {
        ...
        func dfs(_ course: Int) -> Bool {
            guard !completed.contains(course) else { return true }
            guard !visiting.contains(course) else { return false }
            
            guard let neighbors = adjList[course], !neighbors.isEmpty else { return true }
